...
1. Configure the deployment options as an *External repository* pointing to [https://github.com/lzythebset/node-red-azure-webapp.git](https://github.com/lzythebset/node-red-azure-webapp.git)
